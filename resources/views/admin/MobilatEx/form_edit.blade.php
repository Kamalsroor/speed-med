    ...
    <tr>
        ...
        <td class="text-center">
            ...
            <div class="form-group">
                ...
                {!! Form::select('CustomerNames', $Customers, $MobilatDetails[0]->MobilatEx->CustomerNames, ['class' => 'sub_account custom_select select2 form-control' ]) !!}
            </div>
            <div class="form-group">
                 {!! Form::label(' رقم الاذن','رقم الاذن') !!}
                {!! Form::text('premission_id',  $MobilatDetails[0]->MobilatEx->premission_id, ['class' => 'form-control', 'id' => 'CustomerNames', 'placeholder' => 'رقم الاذن']) !!}
            </div>
            <div class="form-group">
               {!! Form::label('رقم الفاتوره','رقم الفاتوره') !!}
                {!! Form::text('order_id',  $MobilatDetails[0]->MobilatEx->order_id, ['class' => 'form-control', 'id' => 'CustomerNames', 'placeholder' => ' رقم الفاتوره']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('تاريخ الاذن ', ' تاريخ الاذن') !!}
                {!! Form::date('date',  $MobilatDetails[0]->MobilatEx->date, ['class' => 'form-control', 'id' => 'PermissionDate', 'placeholder' => 'اسم العميل']) !!}
            </div>
...
<div class="form-group">
        ...
        {!! Form::textarea('note', $MobilatDetails[0]->MobilatEx->note, ['class' => ' form-control', 'placeholder' => 'ملاحظات']) !!}
</div>