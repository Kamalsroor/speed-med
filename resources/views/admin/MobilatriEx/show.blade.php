      ...
      <div class="box">
        <div class="box-header">
          ...
          <img src="{{url('public/photos/logo.jpg')}}" class="user-image" alt="User Image">
            ...
            <h3 class="box-title-Date"> <strong>   ألتاريخ :</strong>{{ money($MobilatEx->date) }}</h3>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="Quantity">{{ $details->sirarnamber }}</td>
          ...
          <h3 class="box-title-Signature"><strong> واستلمت انا الموقع ادناه / ............................................ الاصناف الوارده بالبيان عاليه بحاله جيده , ويوجد مع كل جهاز ضمان خاص بالوكيل</strong> </h3>
